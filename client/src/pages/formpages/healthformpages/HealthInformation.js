            ...
            <div className='container-fluid mt-5'>
              ...
              <ul className="nav nav-pills nav-fill">
                <li className="nav-item">
                  <a className="nav-link active" href="/information/healthInformation">Health Information</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/information/familyInformation">Family Member Information</a>
                </li>
              </ul>
              <hr></hr>
