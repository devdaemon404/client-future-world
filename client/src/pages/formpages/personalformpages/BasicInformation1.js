            ...
            <div className='container-fluid mt-5'>
              ...
              <ul className="nav nav-pills nav-fill">
                <li className="nav-item">
                  <a className="nav-link active" href="/information/basicInformation-1">Basic Information - 1</a>
                </li>
                <li className="nav-item">
              ...
              <form className='mt-2 text-left'>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Company Name</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Emp no.</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Name in full</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="initial|First Name|Middle Name|Last Name" />
                  </div>
                </div>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Name on HRIS</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Father's Name</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
