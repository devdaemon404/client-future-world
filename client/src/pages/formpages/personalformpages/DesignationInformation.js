          ...
          <div className='col-lg-8 order-1 order-lg-2 d-flex flex-column justify-content-start mt-5'>
            ...
            <div className='container-fluid mt-5'>
              ...
              <ul className="nav nav-pills nav-fill">
                ...
                <li className="nav-item">
                  <a className="nav-link active" href="/information/designationInformation">Designation Information</a>
                </li>
                <li className="nav-item">
              ...
              <form className='mt-2 text-left'>
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Joining Date</label>
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Designation</label>
                  <div className="col-sm-9">
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Department</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Reporting to</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Job Level</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Location</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
                ...
                <fieldset className="form-group p-2">
                  <div className="row">
                    <legend className="col-form-label col-sm-3 pt-0"><span style={{ color: 'red' }}>*</span>{' '}Manner of Entry</legend>
                    <div className="col-sm-9">
                ...
                <div className="form-group row p-2">
                  <label className="col-sm-3 col-form-label"><span style={{ color: 'red' }}>*</span>{' '}Nomination</label>
                  <div className="col-sm-9">
                    <input type="text" className="form-control" id="" placeholder="" />
                  </div>
                </div>
